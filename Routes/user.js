...
const front_url = "https://splendid-seahorse-4a780c.netlify.app/"

const transport = nodemailer.createTransport({
    service: "outlook",
    auth: {
        user: 'resetpassword1996@hotmail.com',
...
router.post("/signup", async (req, res) => {
    try {
        ...
        if (usercheck) {
            ...
            const mailOptions = {
                from: 'resetpassword1996@hotmail.com',
                to: user.email,
...
router.get(`/signup/active/${process.env.ACTIVATION_LINK}/:id`, async (req, res) => {
    try {
        ...
        res.redirect("https://splendid-seahorse-4a780c.netlify.app/")
